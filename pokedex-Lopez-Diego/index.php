...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
    ...
    <p class="w3-xlarge">    <form action="buscarPokemon.php" method="post">
        <input type="text" name="pokemonABuscar" placeholder="Ingrese número o nombre de pokemon" >
        <input type="submit" value="Buscar">
    </form></p>
    <button class="w3-button w3-black w3-padding-large w3-large w3-margin-top">Quien es este pokemon?</button>
</header>
